...
for comparazione_numero in range(number):
    ...
    if comparazione == "Increase air speed":
        ...
        st.write(scenarios_df_compare[(scenarios_df_compare["solar_heat_gain_coefficient"] == SHGC_new) & (scenarios_df_compare["THERMAL"] == retrofit_new) & (scenarios_df_compare["VENT"] == vent_new)])
